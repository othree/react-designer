...
function (_Component) {
  ...
  function PanelList() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(PanelList).apply(this, arguments));
  }
  ...
  _createClass(PanelList, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          objectComponent = _this$props.objectComponent,
          id = _this$props.id;
      return _react["default"].createElement("div", {
        style: _objectSpread({}, _styles["default"].propertyPanel)
